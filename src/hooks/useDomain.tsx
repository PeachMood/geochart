...
function getDomain(data: Data): Domain {
...
function scaleLog(domain: Domain) {
...
function scaleDomain(domain: Domain, scale: Scale) {
  return scale === 'linear' ? domain : scaleLog(domain);
}

export default function useDomain(domain: Partial<Domain> = {}, data: Data = [], scale: Scale = 'linear'): Domain {
